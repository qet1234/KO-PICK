...
const styles = StyleSheet.create({
  ...
  title: { marginTop: 6, color: '#101010', fontSize: 28, fontWeight: '900' },
  subtitle: { marginTop: 8, color: '#71716d', fontSize: 14, lineHeight: 21 },
  modeRow: { marginTop: 22, flexDirection: 'row', gap: 10 },
  modeButton: { flex: 1, borderWidth: 1, borderColor: '#dadad4', borderRadius: 18, backgroundColor: '#ffffff', padding: 15 },
  modeButtonActive: { borderColor: '#ff3b36', backgroundColor: '#fff0ee' },
  modeTitle: { color: '#101010', fontSize: 16, fontWeight: '900' },
  modeTitleActive: { color: '#ff3b36' },
  modeDescription: { marginTop: 4, color: '#71716d', fontSize: 11 },
  builder: { marginTop: 12, borderRadius: 23, backgroundColor: '#ffffff', padding: 18 },
  inputGroup: { marginTop: 20 },
  label: { marginBottom: 10, color: '#454541', fontSize: 14, fontWeight: '900' },
  input: { minHeight: 48, borderWidth: 1, borderColor: '#dadad4', borderRadius: 13, color: '#101010', paddingHorizontal: 14, fontSize: 14 },
  searchButton: { minHeight: 50, marginTop: 24, alignItems: 'center', justifyContent: 'center', borderRadius: 14, backgroundColor: '#ff3b36', paddingVertical: 12 },
  ...
  note: { marginTop: 12, color: '#71716d', fontSize: 11, lineHeight: 17 },
  shareNote: { marginTop: 5, color: '#71716d', fontSize: 11, lineHeight: 17 },
  ...
  selectedCard: { marginTop: 12, borderRadius: 18, backgroundColor: '#fff0ee', padding: 16 },
  selectedLabel: { color: '#ff3b36', fontSize: 11, fontWeight: '900' },
  selectedTitle: { marginTop: 4, color: '#101010', fontSize: 18, fontWeight: '900' },
  selectedMeta: { marginTop: 5, marginBottom: 14, color: '#71716d', fontSize: 12, lineHeight: 18 },
  ...
  resultTitle: { color: '#101010', fontSize: 22, fontWeight: '900' },
  source: { marginTop: 5, marginBottom: 8, color: '#71716d', fontSize: 11 },
  card: { marginTop: 12, borderWidth: 1, borderColor: 'transparent', borderRadius: 19, backgroundColor: '#ffffff', padding: 12 },
  cardSelected: { borderColor: '#ff3b36' },
  cardTitle: { color: '#101010', fontSize: 18, fontWeight: '900' },
  cardMeta: { marginTop: 5, color: '#71716d', fontSize: 12, lineHeight: 18 },
