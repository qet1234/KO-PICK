...
import relationshipSoloImage from '../../../assets/images/home/relationship-solo-icon.webp';
import relationshipCoupleImage from '../../../assets/images/home/relationship-couple-icon.webp';
import relationshipFriendImage from '../../../assets/images/home/relationship-friend-icon.webp';
import relationshipFamilyImage from '../../../assets/images/home/relationship-family-icon.webp';
import categoryAttractionImage from '../../../assets/images/home/category-attraction-icon.webp';
import categoryFestivalImage from '../../../assets/images/home/category-festival-icon.webp';
...
const categories = [
  { label: '맛집', icon: '🍴', image: null, category: '맛집', color: '#ff2f2f' },
  { label: '카페', icon: '☕', image: null, category: '카페', color: '#7a3f16' },
  { label: '관광지', icon: '', image: categoryAttractionImage, category: '관광지', color: '#1167c6' },
          ...
          {categories.map((item) => (
            <MotionPressable key={item.label} onPress={() => explore(item.category)} style={styles.categoryButton}>
              <View style={styles.categoryIconCircle}>
                {item.image ? (
                  <Image accessibilityIgnoresInvertColors alt="" resizeMode="cover" source={item.image} style={styles.categoryImage} />
                ) : (
