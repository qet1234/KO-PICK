...
const styles = StyleSheet.create({
  ...
  subtitle: { marginTop: 9, color: '#71716d', fontSize: 14, lineHeight: 21 },
  ...
  checkbox: { width: 22, height: 22, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#dadad4', borderRadius: 6 },
  checkboxChecked: { borderColor: '#ff3b36', backgroundColor: '#ff3b36' },
  checkmark: { color: '#ffffff', fontSize: 13, fontWeight: '900' },
  consentCopy: { flex: 1, paddingHorizontal: 9 },
  consentText: { color: '#454541', fontSize: 13, lineHeight: 18 },
  openText: { color: '#ff3b36', fontSize: 12, fontWeight: '800' },
  quick: { marginTop: 24, marginBottom: 9, color: '#454541', fontSize: 12, fontWeight: '800', textAlign: 'center' },
