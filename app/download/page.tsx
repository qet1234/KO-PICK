...
export const metadata: Metadata = {
  title: "오늘어디 앱 다운로드",
  description: "오늘어디 Android 앱과 iPhone 홈 화면 앱을 설치합니다.",
  robots: {
    index: false,
    follow: false,
  },
    ...
    <main className={styles.page}>
      <section className={styles.card} aria-labelledby="download-title">
        ...
        <p className={styles.description}>
          Android는 APK로, iPhone은 App Store 출시 전에도 홈 화면 앱으로
          설치해 사용할 수 있습니다.
        </p>
        ...
        <div className={styles.notice}>
          ...
          <p>
            ...
            설치’ 권한을 허용해 주세요. iPhone은 별도 개발자 멤버십이나
            TestFlight 없이 Safari의 ‘홈 화면에 추가’ 기능으로 설치합니다.
          </p>
        </div>
      </section>
    </main>
