      ...
      <article className="legal-shell">
        ...
        <div className="legal-content">
          <p className="legal-note">
            오늘어디는 회원 식별과 장소 탐색·저장 기능 제공에 필요한 정보만 처리합니다.
            ...
            <div className="legal-table-wrap">
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>추천·이용 활동</td>
                    <td>무작위 방문자 식별자, 검색 조건, 장소 조회·상세·지도·길찾기·예약·찜 이벤트, API 응답시간·상태코드, 앱 오류 메시지, 생성 시각</td>
                    <td>실시간 인기 장소·검색어 산정, 검색 품질·전환율·장애·성능 개선</td>
                    <td>생성일부터 90일</td>
                  </tr>
                  <tr>
                    <td>장소 정보 신고</td>
                    <td>무작위 방문자 식별자, 공개 장소명·주소·카테고리, 신고 사유·설명, 처리 상태</td>
                    <td>폐업·위치·장소 정보 오류 확인과 수정</td>
                    <td>처리 완료일부터 1년</td>
                  </tr>
                  <tr>
                    <td>기기 저장정보</td>
          ...
          <section>
            ...
            <ul>
              ...
              <li>검색·장소 이용 활동, API 응답시간과 앱 오류 기록은 서비스 이용 중 자동 생성됩니다. 방문자 식별자는 광고 식별자가 아닌 무작위 UUID이며 오류 기록에 이메일·정밀 위치를 넣지 않습니다.</li>
              <li>잘못된 장소 정보 신고는 이용자가 신고 버튼을 눌러 직접 제출한 공개 장소 정보와 신고 내용으로 접수합니다.</li>
              <li>동의를 거부할 수 있으나 회원 전용 저장 기능은 사용할 수 없습니다. 비회원 장소 탐색은 계속 이용할 수 있습니다.</li>
              <li>공개 코스에는 계정·이메일·닉네임·메모 등 회원 식별정보나 개인 입력정보를 넣지 않습니다. 원본 공유 ID 대신 일방향 해시만 서버에 저장합니다.</li>
            </ul>
          </section>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>회원 식별자·이메일·닉네임·프로필 이미지, 추천·운영 활동·장소 신고·지원 요청·공유 코스 데이터 · 인증, 데이터베이스, 서버리스 API</td>
          ...
          <section>
            ...
            <ul>
              ...
              <li>회원탈퇴 시 회원 식별정보와 계정에 연결된 저장·추천 데이터를 삭제합니다.</li>
          ...
          <section>
            ...
            <ul>
              ...
              <li>Supabase Row Level Security와 회원별 접근 통제</li>
              <li>서버 전용 비밀키 분리와 API 요청 제한</li>
